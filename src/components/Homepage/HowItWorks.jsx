   ...
   <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-base text-[#413543] font-semibold tracking-wide uppercase">Process</h2>
          <p className="mt-2 text-4xl leading-8 font-extrabold tracking-tight text-[#655DBB] sm:text-5xl">
            How It Works
          </p>
        ...
        <div className="mt-20">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
            {steps.map((step) => (
              ...
              >
                <div className="absolute -top-4 -right-4 w-16 h-16 bg-[#413543] rounded-full flex items-center justify-center text-white text-2xl font-bold">
                  {step.number}
                </div>
                ...
                <ul className="space-y-3">
                  {step.details.map((detail, index) => (
                    <li key={index} className="flex items-center text-sm text-gray-500">
                      <svg className="h-4 w-4 text-[#3A1078] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-20 text-center">
          <a href='/signin'><button className="px-8 py-4 bg-[#655DBB] text-white rounded-lg font-medium hover:bg-green-600 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
            Get Started Now
          </button></a>
        </div>
      </div>
