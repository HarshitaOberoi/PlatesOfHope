    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-base text-[#FFAB5B] font-semibold tracking-wide uppercase">Impact Stories</h2>
            ...
            {stories.map((story) => (
              <div key={story.title} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div className="relative h-48">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-[#FFAB5B] text-white text-sm font-semibold px-3 py-1 rounded-full">
                    {story.category}
                  </div>
                </div>
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {story.stats.map((stat) => (
                      <div key={stat.label} className="text-center">
                        <div className="text-lg font-bold text-[#]">{stat.value}</div>
                ...
                <div className="px-6 pb-6">
                  <button className="w-full py-3 bg-gray-50 text-[#655DBB] font-medium rounded-lg hover:bg-gray-100 transition-colors">
                    Read Full Story
                  </button>
                </div>
              </div>
        ...
        <div className="mt-16 text-center">
          <button className="px-8 py-4 bg-[#655DBB] text-white rounded-lg font-medium hover:bg-[#BFACE2] transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
            Share Your Story
          </button>
        </div>
      </div>
