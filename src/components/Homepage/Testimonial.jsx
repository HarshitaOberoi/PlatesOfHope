...
const Testimonial = () => {
    const testimonials = [
        {
          content: "PlatesOfHope has helped us reduce our food waste by 75% while helping those in need. It's a win-win solution!",
          author: "John Smith",
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-base text-[#FFDC7F] font-semibold tracking-wide uppercase">Testimonials</h2>
