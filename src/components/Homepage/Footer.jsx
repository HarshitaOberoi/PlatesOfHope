...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#FFB433] text-white">
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Logo & Brand Identity */}
          <div className="space-y-4">
            <h2 className="text-2xl font-bold">PlatesOfHope            </h2>
              ...
              <ul className="space-y-2">
                {['Home', 'Donate Food', 'Find Food', 'Volunteer'].map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-purple-100 hover:text-primary-dark transition-colors duration-300"
                    >
                      {link}
                    </a>
                  </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2">
                <FaEnvelope className="text-purple-100" />
                <a href="mailto:info@foodsaver.com" className="hover:text-purple-100 transition-colors duration-300">
                  info@foodsaver.com
                </a>
              </li>
              <li className="flex items-center space-x-2">
                <FaPhone className="text-purple-100" />
                <a href="tel:+1234567890" className="hover:text-purple-100 transition-colors duration-300">
                  (123) 456-7890
                </a>
              </li>
              <li className="flex items-center space-x-2">
                <FaMapMarkerAlt className="text-purple-100" />
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-2">
              <input
                ...
                className="w-full px-4 py-2 rounded bg-white text-[#FFB433]"
                required
              />
              <button
                type="submit"
          ...
          <div className="flex justify-center space-x-6">
            {[FaFacebook, FaInstagram, FaTwitter, FaLinkedin, FaYoutube, FaPinterest].map((Icon, index) => (
              <a
                key={index}
                href="#"
                className="bg-white p-2 rounded-full text-[#B7B1F2] hover:text-primary-dark transition-colors duration-300"
              >
        ...
        <div className="mt-8 text-center text-sm">
          ...
          <p className="mt-4">© {new Date().getFullYear()} PlatesOfHope. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
