  ...
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-base text-[#3E5879] font-semibold tracking-wide uppercase">Our Partners</h2>
                ...
                <ul className="space-y-4">
                  {companies.map((company) => (
                    <li key={company} className="flex items-center">
                      <svg className="h-5 w-5 text-[#3E5879] mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {testimonials.map((testimonial) => (
              <div key={testimonial.author} className="bg-white p-8 rounded-2xl shadow-lg">
                <div className="flex items-center mb-6">
                  <div className="h-12 w-12 bg-[#3E5879] rounded-full flex items-center justify-center text-white text-2xl font-serif">
                    "
                  </div>
                </div>
