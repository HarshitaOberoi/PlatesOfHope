    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-base text-[#789DBC] font-semibold tracking-wide uppercase">Our Impact</h2>
              ...
              <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                {section.stats.map((stat) => (
                  <div key={stat.label} className="relative bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
                    <div className="absolute -top-4 left-4 bg-[#789DBC] text-white text-xs font-semibold px-3 py-1 rounded-full">
                      {stat.growth}
                    </div>
                    <div className="text-4xl font-bold text-[#EC8305] mb-2">{stat.value}</div>
                    <div className="text-gray-600 font-medium">{stat.label}</div>
                    <div className="absolute bottom-4 right-4">
                      <svg className="h-8 w-8 text-[#364b69]" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-20 text-center">
          <a href="#" className="inline-flex items-center text-[#789DBC] hover:text-[#1F509A] font-medium">
