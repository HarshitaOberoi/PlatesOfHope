        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl text-white">
            ...
            <a href="#volunteer-form" 
               className="inline-flex items-center px-6 py-3 bg-purple-400 hover:bg-yellow-600 
      ...
      <div id="volunteer-form" className="py-24">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <button
                    ...
                    className={`p-4 border rounded-lg flex flex-col items-center gap-2 transition-colors
                              ${formData.transport === label 
                                ? 'border-purple-400 bg-green-50 text-yellow-600' 
            ...
            <button
              type="submit"
              className="w-full py-3 px-6 bg-purple-600 hover:bg-yellow-600 text-white font-semibold rounded-lg transition-colors"
            >
              Submit Application
            </button>
          </form>
            ...
            <div className="divide-y">
              {[1, 2].map((_, i) => (
                <div key={i} className="p-6 flex items-center gap-6">
                  ...
                  <button className="px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-purple-400 transition-colors">
                    View Details
                  </button>
                </div>
              ))}
