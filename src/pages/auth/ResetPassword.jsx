        ...
        >
          <div className="text-center">
            <motion.div
              ...
              <Lock className="h-8 w-8 text-[#D98324]" />
            </motion.div>
            <motion.h2
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            ...
            onClick={resetPasswordHandler}
              ...
              className={`group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white 
                ${password && confirmPassword && password === confirmPassword 
                  ? 'bg-[#D98324] hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500' 
                  : 'bg-purple-400 cursor-not-allowed'}`}
            >
              <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                <Lock className="h-5 w-5 text-purple-500 group-hover:text-purple-300" aria-hidden="true" />
              </span>
