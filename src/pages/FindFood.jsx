        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="text-white max-w-2xl">
            ...
            <div className="flex gap-4">
              <a href='#listing'><button className="bg-yellow-600 hover:bg-purple-300 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors">
                Request Food
              </button></a>
          ...
          <div className="grid md:grid-cols-4 gap-12">
            {[
              ...
              <div key={index} className="text-center group cursor-pointer">
                <div className="w-20 h-20 mx-auto mb-6 bg-green-100 rounded-2xl flex items-center justify-center transform transition-transform group-hover:scale-110 group-hover:bg-purple-300">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-purple-400 focus:border-yellow-600"
                value={location}
            ...
            <div className="relative">
              ...
              <select
                className="w-full pl-12 pr-4 py-3 border-2 rounded-xl appearance-none focus:ring-2 focus:ring-purple-400 focus:border-yellow-600"
                value={category}
            ...
            <div className="relative">
              ...
              <select
                className="w-full pl-12 pr-4 py-3 border-2 rounded-xl appearance-none focus:ring-2 focus:ring-purple-400 focus:border-yellow-500"
                value={distance}
            ...
            <button className="bg-purple-700 hover:bg-yellow-700 text-white px-8 py-3 rounded-xl font-semibold transition-colors text-lg">
              Search Food
            </button>
          </div>
        </div>
                ...
                <div className="w-3/5 p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {item.tags.map((tag, index) => (
                      <span key={index} className="bg-green-100 text-yellow-700 px-3 py-1 rounded-full text-sm">
                        {tag}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="flex gap-3">
                    <button className="flex-1 bg-purple-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors">
                      Request Food
                    </button>
